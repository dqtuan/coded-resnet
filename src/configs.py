...
# modes
parser.add_argument('--evalFgan', action='store_true')
...
parser.add_argument('--evalFnet', action='store_true')
parser.add_argument('--evalFnet2', action='store_true')
parser.add_argument('--evalDistill', action='store_true')
