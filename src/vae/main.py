...
parser.add_argument('--z-size', type=int, default=32*32*3)
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        images = vae.sample(25)
        torchvision.utils.save_image(images.cpu(), "../../results/train_samples.jpg", int(25**.5), normalize=True)
    else:
        epoch = utils.load_checkpoint(vae, args.checkpoint_dir)
        images = vae.sample(25)
        torchvision.utils.save_image(images.cpu(), "../../results/test_sample.jpg", int(25**.5), normalize=True)
